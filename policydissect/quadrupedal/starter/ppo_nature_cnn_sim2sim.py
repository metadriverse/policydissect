...
def experiment(args):
  ...
  if "get_image_interval" in eval_params["env"]["env_build"] and eval_params["env"]["env_build"]["get_image_interval"] > 1:
  ...
  elif "get_image_interval" in eval_params["env"]["env_build"] and eval_params["env"]["env_build"]["get_image_interval"] == 1 and eval_params["env"]["env_build"]["frame_extract"] == 1:
